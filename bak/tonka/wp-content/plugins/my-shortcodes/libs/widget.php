...
class msc_widget extends WP_Widget {
        function msc_widget() {
            ...
            parent::WP_Widget('ceelements', 'My Shortcodes', $widget_ops, $control_ops);
        }
    ...
    function form($instance) {            
            ...
            if(empty($Elements)){
                ...
                if(empty($cats)){
                    echo '<p>You don\'t have any active Widget or Hybrid elements.</p>';
                    return;
                }
            ...
            if(!empty($instance['_category']) && !empty($instance['_element'])){
                echo "</div>\n";
            echo '<div class="hide-if-no-js show-element-selector-tab">
