    ...
    <?php wp_nonce_field('cs-edit-shortcode'); ?>
        <div class="header-nav">
            ...
            <ul class="editor-section-tabs navigation-tabs">
                ...
                <li class="divider-vertical"></li>
                <li><button id="element-apply" type="button" class="button">Apply</button></li>
                <li><button type="submit" class="button">Save</button></li>
                <li class="divider-vertical"></li><?php
                /*
                <li><button id="preview-toggle" type="button" class="button <?php if(!empty($Element['__showpreview__'])){ echo 'active'; } ?>">Revisions</button></li>
                <li class="divider-vertical"></li> */
                ?>
                <li><button id="preview-toggle" type="button" class="button <?php if(!empty($Element['__showpreview__'])){ echo 'active'; } ?>">Preview</button></li>
                <li class="divider-vertical"></li>
