...
<h2 style="display:none;"><!-- hack to force notices below here. not much in docs on how to do it properly. oh well. --></h2>
    ...
    <div class="save_bar_tools">
        <span class="fbtn"><a href="?page=my-shortcodes&action=edit"><div id="addNewInterface" class="button"><span class="icon-plus-sign" style="margin:3px 0 0 -2px;"></span> New Element</div></a></span>
        <span class="fbtn"><a href="#importer_screen" id="importer"><div class="button"><span class="icon-upload" style="margin:3px 0 0 -2px;"></span> Import MSC File</div></a></span>
        &nbsp;&nbsp; <span class="fbtn"><a href="mailto:david@caldera.co.za?subject=My Shortcodes Feedback" id="feedback"><div class="button"><span class="icon-comment" style="margin:3px 0 0 -2px;"></span> Send Feedback</div></a></span>
    ...
    <div id="main">
            ...
            if(!empty($toUpdate)){
                ...
                echo '<div class="description">Things have changed since the last update. These elements need to be upgraded to retain compatibility.</div>';
                    ...
                    foreach($toUpdate as $updateID=>$val){
                        echo '<span class="fbtn"><div id="upg_'.$updateID.'" class="elementUpgradeNodes" style="float:left; padding:3px; border-radius:4px; background:#ed0000; color:#fff;margin:3px;">'.$Elements[$updateID]['name'].'</div></span>';
                    }
                    //echo '</ul>';
                    ?>
                        <div class="exportbuttonbar clear">

                            <span id="upgradeElementsButton" class="fbtn" onclick="msc_upgradeElements();"><button type="button" class="button"><i class="icon-ok-sign"></i> Upgrade Elements</button></span>
                        </div>
            <?php
                echo "</div>\n";
            }
        ...
        ?>
            <div style="display: <?php echo $Show; ?>;" class="group" id="<?php echo $tabid; ?>">
                <span class="fbtn exporter" style="float:right; padding: 6px 3px 3px 3px;">
                    <a href="#<?php echo sanitize_key(strtolower($page)); ?>">
                        <div class="button" id="addNewInterface">
                            <span style="margin:3px 0 0 -2px;" class="icon-eye-open"></span> Show Export Config</div>
                    </a>
                </span>
                <span class="fbtn manager" style="float:right; padding: 6px 3px 3px 3px; display: none;">
                    <a href="#<?php echo sanitize_key(strtolower($page)); ?>">
                        <div class="button" id="addNewInterface">
                            <span style="margin:3px 0 0 -2px;" class="icon-eye-close"></span> Hide Export Config</div>
                    </a>
                </span>
                ...
                <div class="catexport" style="display:none;">
                    <form action="?page=my-shortcodes" method="post" id="elementEditForm">
                        ...
                        <div class="exportbuttonbar">
                            ...
                            <span class="fbtn"><button type="submit" value="plugin" class="button"><i class="icon-download-alt"></i> Export</button></span>                            
                ...
                <div class="cs-elementItem elementMain <?php echo $isError.' '.$isLast; ?>" title="<?php echo $errorTitle; ?>">
                    ...
                    <div class="cs-elementInfoPanel mid">
                        <span class="fbtn"><span class="button button-small infoTrigger" rel="<?php echo $Element; ?>" rel="tooltip" title="Show Details" data-placement="left"><i class="icon-cog"></i></span></span>
                        <?php
                        if(!empty($isError)){
                        ?>
                        <span class="fbtn"><a><span rel="tooltip" title="Cannot activate as there is an error." class="button button-small disabled <?php echo $activeClass; ?>" data-placement="right" <?php echo $errorEnable; ?>><span class="icon-ok-circle" style="cursor:pointer;"></span></span></a></span>
                        <?php
                        }else{
                        ?>
                        <span class="fbtn"><a href="?page=my-shortcodes&action=activate&element=<?php echo $Element.$fromActive; ?>"><span rel="tooltip" title="<?php if(!empty($activeClass)){ echo 'Deactivate'; }else{ echo 'Activate'; }; ?>" class="button button-small <?php echo $activeClass; ?>" data-placement="right"><span class="icon-ok-circle" style="cursor:pointer;"></span></span></a></span>
                        <?php
                        }
                        ?>
                    </div>
                    <div id="" class="cs-elementInfoPanel last buttonbar buttons_<?php echo $Element; ?>" style="display:block;">                        
                        ...
                        <span class="fbtn"><a href="?page=my-shortcodes&action=edit&element=<?php echo $Element; ?>"><div class="button button-small" rel="tooltip" title="Edit Element" data-placement="left"><span class="icon-edit"></span></div></a></span>
                        <span class="fbtn"><a href="?page=my-shortcodes&action=dup&element=<?php echo $Element; ?>"><div class="button button-small" rel="tooltip" title="Duplicate Element" data-placement="left"><span class="icon-chevron-down"></span></div></a></span>
                        <span class="fbtn"><a href="#" class="confirm" rel="<?php echo $Element; ?>" onclick="return false;"><div class="button button-small" rel="tooltip" title="Delete Element" data-placement="right"><span class="icon-remove-sign"></span></div></a></span>
                    </div>
                    <div id="confirm_<?php echo $Element; ?>" class="cs-elementInfoPanel last buttons_<?php echo $Element; ?>" style="display:none;">
                        ...
                        <span class="fbtn"><a href="#" onclick="msc_deleteElement('<?php echo $Element; ?>'); return false;"><div class="button button-small" rel="tooltip" title="Confirm Delete" data-placement="left"><span class="icon-ok"></span></div></a></span>
                        <span class="fbtn"><a href="#" onclick="return false;" class="confirm" rel="<?php echo $Element; ?>"><div class="button button-small"><span class="icon-share-alt"></span> Cancel</div></a></span>
...
?>
                ...
                <div class="cs-elementItem">
                    ...
                    <div id="" class="cs-elementInfoPanel last buttonbar buttons_<?php echo $Element; ?>" style="display:block;">
                        <span class="fbtn"><a href="?page=my-shortcodes&action=edit&element=<?php echo $Element; ?>"><div class="button"><span class="icon-edit"></span></div></a></span>
                        <span class="fbtn"><a href="?page=my-shortcodes&action=edit&childof=<?php echo $Element; ?>"><div class="button"><span class="icon-indent-left"></span></div></a></span>
                        <span class="fbtn"><a href="#" class="confirm" rel="<?php echo $Element; ?>" onclick="return false;"><div class="button"><span class="icon-remove-sign"></span></div></a></span>
                    </div>
                    <div id="confirm_<?php echo $Element; ?>" class="cs-elementInfoPanel last buttons_<?php echo $Element; ?>" style="display:none;">
                        <div class="infoDelete">Delete Element</div>
                        <span class="fbtn"><a href="#" onclick="msc_deleteElement('<?php echo $Element; ?>'); return false;"><div class="button"><span class="icon-ok"></span></div></a></span>
                        <span class="fbtn"><a href="#" onclick="return false;" class="confirm" rel="<?php echo $Element; ?>"><div class="button"><span class="icon-share-alt"></span> Cancel</div></a></span>
