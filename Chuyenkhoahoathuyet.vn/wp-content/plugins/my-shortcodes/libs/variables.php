<div style="padding: 3px 0 10px;">
    <button type="button" onclick="msc_expandVariables();" class="button" style="float:right;"><i class="icon-resize-full"></i> Expand All</button>
    <button type="button" onclick="msc_contractVariables();" class="button" style="float:right; margin-right: 10px;"><i class="icon-resize-small"></i> Contract All</button>
    <button type="button" onclick="msc_addVariable();" class="button"><i class="icon-plus"></i> Add Attribute</button>
</div>
<div id="variablePane">
<?php
    ...
    if(!empty($Element['_variable'])){
        foreach($Element['_variable'] as $key=>$var){
            ...
            echo '<div class="attributeFooter">';                
                echo '<a class="removal button button-small" href="#" onclick="jQuery(this).slideUp(130,function(){jQuery(this).parent().find(\'.confirm\').slideDown(130)}); return false;"><i class="icon-remove"></i> Remove Attribute&nbsp;</a>';
                echo '<a class="confirm button button-small" href="#" onclick="jQuery(\'#'.$key.'\').slideUp(130, function(){jQuery(this).remove()}); return false;" style="display:none;"><i class="icon-check"></i> Confirm?&nbsp;</a> <a class="confirm button button-small" href="#" onclick="jQuery(this).parent().find(\'.confirm\').slideUp(130, function(){jQuery(this).parent().find(\'.removal\').slideDown(130)}); return false;" style="display:none;"><i class="icon-share-alt"></i> Cancel&nbsp;</a>';
            echo '</div>';
        echo '</div>';
        }
    }
