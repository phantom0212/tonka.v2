                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-6 col-tn-12">
                    ...
                    <?php foreach ($postslist_cate as $post) :
                        ...
                        <div id="box_hot_folder" class="space_bottom_20">
                            <div class="content_box">
								...
								?>
                                        <?php //if(count(get_post_meta(get_the_ID(),'description'))>0){ $des =  get_post_meta(get_the_ID(),'description')[0]; echo wp_trim_words( $des, 56, null ); }else{echo wp_trim_words( get_the_excerpt(), 56, null );} ?>
                                    </h4>
                                </div>
                            </div>
                        </div>
                        <?php if($stt%11 == 2){ ?>
                            <div class="item_list_news_folder" style>
                                <?php dynamic_sidebar('quangcao_cate'); ?>
                            </div>
                        <?php } ?>
                    ...
                    <div class="list_news_folder space_bottom_20 width_common">
                        <div class="list_sub_news width_common">
                            ...
                            <?php foreach ($postslist_cate as $post) :
                                setup_postdata($post);
                                $image = get_post_thumb(get_the_ID(), 235, 150);
                                $src = $image['src'];
                                if($stt !=0){ ?>
