                    ...
                    <div id="detail_page">
                        <div id="box_detail">
                            ...
                            <h3 class="lead_detail_page">
                                <?php if(get_post_meta(get_the_ID(),'description', true) !=""){ echo get_post_meta(get_the_ID(),'description')[0]; } ?>
                            </h3>
                           <!-- <div class="">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-7 col-tn-12 space_bottom_10">
                        <div id="video_hot" class="space_bottom_10">
                            ...
                            <div class="content_box">
								...
								<div class="pull-left social_left" style="width:100%;padding: 10px 0;">
                                    <div class="fb-like" data-href="<?php echo $curr_url; ?>" data-layout="standard"
                                         data-action="like" data-size="small" data-show-faces="false"
                                         data-share="true"></div>
                                </div>
