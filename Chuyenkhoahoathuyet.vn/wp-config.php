...
define('DB_NAME', 'chuyenkhoahoathuyet');
...
define('WP_HOME','http://chuyenkhoahoathuyet.vn');
define('WP_SITEURL','http://chuyenkhoahoathuyet.vn');
define('THEME_NAME','twentyseventeen');
