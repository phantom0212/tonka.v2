...
if ( ! defined('ABSPATH')) exit;  // if direct access 
	...
	if ( ! function_exists( 'qa_action_single_question_main_function' ) ) {
		function qa_action_single_question_main_function() {
			...
			do_action('qa_action_question_status');
	...
	add_action( 'qa_action_question_status', 'qa_action_question_status_function', 10 );	
	...
	if ( ! function_exists( 'qa_action_question_status_function' ) ) {
		function qa_action_question_status_function() {
			require_once( QA_PLUGIN_DIR. 'templates/single-question/status.php');
		}
	}
