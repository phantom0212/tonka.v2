...
class class_qa_addons{
	...
	public function addons_data($addons_data = array()){
		...
		$addons_data_new = array(
			...
			'import-awesome-support'=>array(	'title'=>'Import AnsPress - Awesome Support',
										'version'=>'1.0.0',
										'price'=>'0',
										'content'=>' Import Question and Answer from AnsPress - Question and answer plugin.',										
										'item_link'=>'https://wordpress.org/plugins/question-answer-import-awesome-support/',
										'thumb'=>QA_PLUGIN_URL.'assets/admin/images/addons/import-awesome-support.png',							
			),
