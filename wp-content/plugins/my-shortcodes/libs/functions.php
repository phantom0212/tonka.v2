...
function msc_button() {
    ...
    echo "<a onclick=\"return false;\" id=\"my-shortcodes\" title=\"Caldera Shortcodes Builder\" class=\"thickbox button\" href=\"?myshortcodeproinsert=insertTB_iframe=1&width=640&height=307\" style=\"padding: 0px 7px 0px 2px;\">\n";
    echo "<img src=\"".MYSHORTCODES_URL."images/icon.png\" alt=\"Insert Shortcode\" width=\"15px\" height=\"15px\" style=\"padding-bottom: 1px;\" /> My Shortcodes\n";
    echo "</a>\n";
}
...
function msc_menus() {
    ...
    add_menu_page("Caldera - Elements Manager", "My Shortcodes", 'activate_plugins', "my-shortcodes", "msc_adminPage", "dashicons-editor-code");
    $calderaAdminPage = add_submenu_page("my-shortcodes", 'My Shortcodes', 'Shortcode Builder', 'activate_plugins', "my-shortcodes", 'msc_adminPage', "dashicons-editor-code");
...
function msc_selectedgetcat(){
    ...
    echo "</select>\n";
    echo "<span class=\"fbtn\"><input type=\"submit\" class=\"widget-control-save button loadElementControl-btn\" value=\"Load Element\" /></span>";
    die;
    ...
    $Return .= '  <td>';
        ...
        switch ($Type){
            ...
            case 'File':
                ...
                $Return .= '<div id="uploader_field_'.$ID.'" class="fbtn" onclick="msc_openMediaPanel(\''.$Name.'\');" style="float:none; display:inline;">';
        ...
        if($isFirst){
            $Return .= '<div id="remover_field_'.$ID.'" class="fbtn remover" style="float:none; display:inline;">';
