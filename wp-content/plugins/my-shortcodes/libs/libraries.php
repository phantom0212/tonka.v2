<div style="padding: 3px 0 10px;">
    <button type="button" onclick="msc_addJSLibrary();" class="button"><i class="icon-plus"></i> Add JavaScript Library</button>
    <button type="button" onclick="msc_addCSSLibrary();" class="button"><i class="icon-plus"></i> Add CSS Library</button>
</div>
