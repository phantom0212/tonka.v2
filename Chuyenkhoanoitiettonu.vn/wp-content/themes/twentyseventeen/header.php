...
<link rel="shortcut icon" href="<?php  echo get_theme_file_uri(); ?>/Amanda.ico" type="image/x-icon" />
<?php wp_head(); ?>
    ...
    <link rel="stylesheet" href="<?php  echo get_theme_file_uri(); ?>/assets/css/amanda.css?v=2" media="all" />
...
})(window,document,'script','dataLayer','GTM-KPVLQMF');</script>
<!-- End Google Tag Manager -->
</head>
<body <?php body_class(); ?> >
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KPVLQMF"
...
<div id="page" class="homepage">
    ...
    <div id="menu_tablet" class="width_common hidden-lg hidden-md"><a href="<?php echo home_url('/'); ?>" class="logo"></a>
