        ...
        <div class="container">
            <div class="row">
                <div id="box_moinhat" class="col-lg-4 col-md-4 col-sm-4 col-xs-6 col-tn-12 space_bottom_10">
                    <div class="title_box"><h3><a href="<?php echo get_site_url() . SLUG_TINMOINHAT; ?>">Bài viết mới
                                nhất</a></h3></div>
                    <div class="content_box">
                                ...
                                <div class="item_sub_news">
                                    ...
                                    <h2 class="title_box_news">
                                        <a href="<?php echo get_permalink() ?>"
                                           class="four-lines"><?php the_title() ?></a>
                                    </h2>
                                </div>
                                <?php
                            }
                        ...
                        <div class="block_xemthem text-center">
                            <a href="<?php echo get_site_url() . SLUG_TINMOINHAT; ?>" class="txt_666"><i
              ...
              /*  $defaults = array(
                ...
                $max_query = new WP_Query(array('post_type' => 'posts', 'post_status' => 'publish', 'orderby' => 'meta_value', 'order' => 'DESC', 'meta_key' => 'post_views_count', 'posts_per_page' => 1));*/
                ...
                <div id="box_tinxemnhieu" class="col-lg-4 col-md-4 col-sm-4 col-xs-6 col-tn-12 space_bottom_10">
                    <div class="title_box"><h3><a href="<?php echo get_site_url() . SLUG_TINXEMNHIEU; ?>">Tin Xem
                                Nhiều</a>
                        </h3></div>
                    <div class="content_box">
                        <div class="block_news width_common">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-tn-12">
                    ...
                    $postslist = get_posts($args);
                    $stt = 0; ?>
                    <div id="box_suckhoe_lamdep" class="box_common_site">
                        <?php if (count($postslist) > 0) { ?>
                            <div class="title_box_common">
                                <h3 class="wap_title_box relative">
                                    <img src="<?php echo get_theme_file_uri(); ?>/assets/images/icon/ico_woman.png"
                                         class="icon_title">
                                    <a class="text_title_box"
                                       href="<?php echo esc_url($category_link); ?>"><?php echo $category->name; ?></a>
                                </h3>
                            ...
                            <div class="content_box_common width_common">
                                <div class="list_tuvan width_common">
                                    ...
                                    <div class="block_txt_datcauhoi text-center"><a
                                            href="<?php echo home_url('/tu-van-chia-se'); ?>"
                                            ...
                                            <li>
                                                <div class="item_video">
                                                    <div class="thumb_video relative">
                                                        ...
                                                        <a href="<?php the_permalink() ?>" class="masking_video1">
                                                            &nbsp;</a>
