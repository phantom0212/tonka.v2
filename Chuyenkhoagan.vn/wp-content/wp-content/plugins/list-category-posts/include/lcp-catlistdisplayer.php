...
class CatListDisplayer
{
    ...
    public function get_pagination()
    {
        ...
        if ($lcp_pag_param_present && $this->params['pagination'] == "yes" ||
            ...
            if ($pages_count > 1) {
                ...
                $pag_output .= "<div class='lcp_paginator'>";
    ...
    private function lcp_page_link($page, $char = null)
    {
        ...
        if ($page == $current_page) {
            ...
            $link .= "<div class='content_box'><a href='$page_link' title='$page'>";
    ...
    private function get_conditional_title()
    {
        ...
        return $this->assign_style($this->catlist->get_conditional_title(), 'h3', $class);
    }
