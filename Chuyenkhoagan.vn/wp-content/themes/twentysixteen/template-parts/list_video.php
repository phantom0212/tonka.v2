...
<div id="video_page">
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-7 col-tn-12 space_bottom_10">
            <div id="video_hot" class="space_bottom_10">
                ...
                while (have_posts()) {
                    ...
                    <?php if ($i === 1) : ?>
                    <?php
							  $image = get_post_thumb(get_the_id(), 650, 400);
					?>
                                ...
                                <div class="block_thumb_video width_common">
									<div class="item_video relative format_video">
                                        <div class="thumb_video relative">
                                            <div class="thunb_image thumb_5x3"><a href="<?php echo get_the_permalink() ?>"><img alt=""
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-5 col-tn-12 space_bottom_10">
            <?php do_shortcode('[postCategory category_id=11 number_post=5 type="Video-Sidebar" name="Video Nổi Bật" link="/category/kho-video/video-noi-bat" icon="/wp-content/themes/twentysixteen/tonka/images/icon/ico_non.png" ]') ?>
        </div>
    </div>
