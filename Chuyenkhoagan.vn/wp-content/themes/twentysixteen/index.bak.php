...
<div class="container">
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-6 col-tn-12">
            ...
            <?php do_shortcode('[postCategory category_id=8 number_post=4 type="Normal" name="KIẾN THỨC HÀN LÂM" link="" icon="/wp-content/themes/twentysixteen/tonka/images/icon/ico_non.png" ]') ?>
